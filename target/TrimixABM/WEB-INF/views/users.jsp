		...
		$.ajax({
			...
			success: function(response){
					...
					for(i=0; i<response.data.length; i++){					
						$("#table").append("<tr class='table'>" + "<th scope='row' >" + (i+1) + "</th>" + "<td> "+response.data[i].user_name+" </td> <td> "+response.data[i].email+" </td> <td> <a href='#' onclick= edit("+i+");> Edit </a>  </td> </td> <td> <a href='#' onclick='delete_("+response.data[i].user_id+");'> Delete </a>  </td> </tr>");
					}			
			}				
		});
